...
\begin{figure}
\includegraphics[width=0.4\linewidth]{images/project3} \includegraphics[width=0.4\linewidth]{images/project4} \caption{R prject 생성}\label{fig:unnamed-chunk-16}
\end{figure}
...
\DocumentationTok{\#\# Warning in install.packages("nycflights13", repos =}
\DocumentationTok{\#\# "http://cran.us.r{-}project.org"): \textquotesingle{}lib =}
\DocumentationTok{\#\# "/Library/Frameworks/R.framework/Versions/4.5{-}arm64/Resources/library"\textquotesingle{} is not}
\DocumentationTok{\#\# writable}
\DocumentationTok{\#\# Error in \textasciigrave{}install.packages()\textasciigrave{}:}
\DocumentationTok{\#\# ! unable to install packages}
\FunctionTok{library}\NormalTok{(nycflights13)}
\DocumentationTok{\#\# Error in \textasciigrave{}library()\textasciigrave{}:}
\DocumentationTok{\#\# ! there is no package called \textquotesingle{}nycflights13\textquotesingle{}}
\FunctionTok{head}\NormalTok{(flights) }\CommentTok{\# head 자료 수개를 보여줌}
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}flights\textquotesingle{} not found}
...
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}flight\_df\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{flight\_df }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{mean\_distance=}\NormalTok{distance}\SpecialCharTok{/}\NormalTok{hour, }
         \AttributeTok{ratio\_delay=}\NormalTok{arr\_delay}\SpecialCharTok{/}\NormalTok{(hour}\SpecialCharTok{*}\DecValTok{60}\SpecialCharTok{+}\NormalTok{minute)) }\OtherTok{{-}\textgreater{}}\NormalTok{ flght\_df\_mutate1}
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}flight\_df\textquotesingle{} not found}
...
\NormalTok{flight\_df }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{transmute}\NormalTok{(}\AttributeTok{total\_min=}\NormalTok{hour}\SpecialCharTok{*}\DecValTok{60}\SpecialCharTok{+}\NormalTok{minute) }\OtherTok{{-}\textgreater{}}\NormalTok{ flight\_df\_mutate2}
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}flight\_df\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}flight\_df\_mutate\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{flight\_df\_mutate }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{max\_s=}\FunctionTok{max}\NormalTok{(arr\_delay),}
            ...
            \AttributeTok{per25\_s=}\FunctionTok{quantile}\NormalTok{(arr\_delay, }\DecValTok{0}\NormalTok{,}\DecValTok{25}\NormalTok{))}
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}flight\_df\_mutate\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{flight\_df\_mutate }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{max\_s=}\FunctionTok{max}\NormalTok{(arr\_delay),}
            ...
            \AttributeTok{mean\_s=}\FunctionTok{mean}\NormalTok{(arr\_delay), }
            \AttributeTok{med\_s=}\FunctionTok{median}\NormalTok{(arr\_delay), }
            \AttributeTok{per20\_s=}\FunctionTok{quantile}\NormalTok{(arr\_delay, }\DecValTok{0}\NormalTok{,}\DecValTok{25}\NormalTok{),}
            \AttributeTok{n\_s=}\FunctionTok{n}\NormalTok{())}\OtherTok{{-}\textgreater{}}\NormalTok{final}
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}flight\_df\_mutate\textquotesingle{} not found}
\NormalTok{final}
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}final\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{data1 }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{left\_join}\NormalTok{(data2, }\AttributeTok{by=}\StringTok{"id"}\NormalTok{, }\AttributeTok{suffix=}\FunctionTok{c}\NormalTok{(}\StringTok{"\_data1"}\NormalTok{, }\StringTok{"data2"}\NormalTok{)) }\OtherTok{{-}\textgreater{}}\NormalTok{ left3}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Error in \textasciigrave{}make.names()\textasciigrave{}:}
\DocumentationTok{\#\# ! invalid multibyte string at \textquotesingle{}\textless{}ff\textgreater{}\textless{}fe\textgreater{}c\textquotesingle{}}
...
\DocumentationTok{\#\# Error in \textasciigrave{}file()\textasciigrave{}:}
\DocumentationTok{\#\# ! unsupported conversion from \textquotesingle{}utf16\textquotesingle{} to \textquotesingle{}\textquotesingle{}}
\DocumentationTok{\#\# Error in \textasciigrave{}invokeRestart()\textasciigrave{}:}
\DocumentationTok{\#\# ! invalid connection}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Error in \textasciigrave{}count()\textasciigrave{}:}
...
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}company\_4\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{company\_4\_se }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{filter}\NormalTok{(n}\SpecialCharTok{\textgreater{}}\DecValTok{1}\NormalTok{)}
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}company\_4\_se\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}company\_full\textquotesingle{} not found}
...
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}c3\_ind1\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{company\_inner }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{count=}\FunctionTok{n}\NormalTok{())}
\DocumentationTok{\#\# Error:}
\DocumentationTok{\#\# ! object \textquotesingle{}company\_inner\textquotesingle{} not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{worker\_company\_inner }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{count=}\FunctionTok{n}\NormalTok{())}
\DocumentationTok{\#\# \textasciigrave{}summarise()\textasciigrave{} has regrouped the output.}
\DocumentationTok{\#\# i Summaries were computed grouped by w3\_id1 and w3\_id4.}
\DocumentationTok{\#\# i Output is grouped by w3\_id1.}
\DocumentationTok{\#\# i Use \textasciigrave{}summarise(.groups = "drop\_last")\textasciigrave{} to silence this message.}
\DocumentationTok{\#\# i Use \textasciigrave{}summarise(.by = c(w3\_id1, w3\_id4))\textasciigrave{} for per{-}operation grouping}
\DocumentationTok{\#\#   (\textasciigrave{}?dplyr::dplyr\_by\textasciigrave{}) instead.}
...
\DocumentationTok{\#\# \# i 2,392 more rows}
...
\NormalTok{worker\_company\_inner }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{count=}\FunctionTok{n}\NormalTok{())}
\DocumentationTok{\#\# \textasciigrave{}summarise()\textasciigrave{} has regrouped the output.}
\DocumentationTok{\#\# i Summaries were computed grouped by c3\_ind1 and w3\_ind1.}
\DocumentationTok{\#\# i Output is grouped by c3\_ind1.}
\DocumentationTok{\#\# i Use \textasciigrave{}summarise(.groups = "drop\_last")\textasciigrave{} to silence this message.}
\DocumentationTok{\#\# i Use \textasciigrave{}summarise(.by = c(c3\_ind1, w3\_ind1))\textasciigrave{} for per{-}operation grouping}
\DocumentationTok{\#\#   (\textasciigrave{}?dplyr::dplyr\_by\textasciigrave{}) instead.}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-59-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-60-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-72-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-73-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-77-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-78-2.png}}
...
우리가 연구 장면에서 마주하는 통계는 크게 두가지, (1) \textbf{기술통계}와 (2) \textbf{추론통계}로 구분된다. 기술통계는 \textbf{descriptive statistics}로 불리며, 말그대로 자료data를 기술(describing) 하는 목적을 갖는다. 추론통계는 \textbf{inference statistics}로 불리우며, 표본sample에서 확인되는 통계량statistics로 모집단population의 모수치parameter를 추정(inferering) 하는것을 목적으로 한다.
...
추론통계와 기술통계의 가장 큰 차이는 \textbf{확률 probability}의 유무이다. 추론통계는 표본량을 활용해 모수치를 추정하는 과정에서 확률의 개념이 활용된다는 점이 가장 특징적이다.

확률은 \textbf{경험 또는 실험 결과로 특정한 사건이나 결과가 발생할 가능성}을 의미한다. 가장 대표적인 확률은 주사위를 던졌을 때(실험) 각각의 눈이 나올 확률(특정 사건이 발생하는 가능성)이다. 이때 연구자가 주사위를 한번던져서 나온 눈의 개수를 변수값(value)로 정의하여 이를 변수 X로 정의한다면 X는 \textbf{확률변수}가 된다. 여기서 \textbf{변수variable} 의 정의에 대해 추가로 이해할 필요가 있다. 변수는 상수constant와 달리 ``변하는 수''이며 특정한 척도로 측정하여 그 결과를 수치로 기록한 값을 의미한다. 결국 변수에는 (1)다양한 변수값이 부여되고, (2)변수값은 ``척도로 측정''한다는 의미를 동시에 갖고 있다.
...
이때 확률변수 X는 비연속적인 값을 갖고 있다. 즉 값의 갯수를 셀수 있다(0, 2, 4중 하나의 값만 가진다). 이처럼 변수값이 한정적인 경우는 \textbf{이산확률변수(discrete random variable)}라고 명명한다. 반대로 확률변수 값의 갯수를 셀 수 없는 경우가 \textbf{연속확률변수(continuous random variable)}이다. 연속확률변수 X는 실생활에서 자주 찾아볼 수 있다. 20대 여성의 키(cm), 우리나라 성인의 (IQ), 고등학교 진로교육만족도(5점 likert) 등이 대표적이다.
...
\subsubsection{확률질량함수 (probability mass funtion, pmf)}\label{uxd655uxb960uxc9c8uxb7c9uxd568uxc218-probability-mass-funtion-pmf}
...
위의 설명은 아래의 수식\eqref{eq:prob}을 통해 보다 명확히 이해할 수 있다. 중요한 것은 확률변수 X가 발생할 확률은 구간의 면적과 같다는 점이다. 이 원리는 앞으로 다양한 확률분포를 활용해서 가설을 검정할때 사용되므로 분명히 이해하는 것이 좋다.
...
\begin{equation}
X\sim N(\mu, \sigma)\label{eq:normal}
\end{equation}
...
표준정규분포는 특수한 형태의 정규분포이다. 즉, 수많은 정규분포 중 하나이다. 표준정규분포는 평균(\(\mu\))은 0이고, 분산(\(\sigma\))은 1인 정규분포이다(\eqref{eq:stno}).
...
다행히 모든 정규본포는 확률변수의 표준화를 통해 표준정규분포로 변환시킬 수 있다. 따라서 표준정규분포의 구간 적분값을 이용해서 모든 정규분포의 구간 적분값을 구할 수 있다.
...
우리는 표준정규분포의 P(-2\textless Z\textless0)의 확률을 확인함으로서, 별도의 적분없이 확률변수 X의 구간의 확률을 구할 수 있다. 왜냐하면 표준정규분포의 구간확률은 이미 계산되어 알려져있기 떄문이다. 거의 모든 통계책의 뒷면을 보면 표준정규분포를 포함한 대표분포의 구간확률이 이미 계산되어 있다.
...
F 분포는 카이제곱분포와 유사하게 항상 양의 값만을 가지며, 오른쪽 꼬리 모양을 갖는 비대칭 포이다. 마찬가지로 2개의 자유도 값에 따라 모양이 변하고, 자유도가 커질수록 정규분포에 가까워진다.
...
이 5개의 확률변수는 동일한 모집단(서울대학교 재학생)에서 추출되었다. 만일 모집단의 분포가 평균 \(μ\), 분산은 \(σ^2\) 인 정규분포라고 가정해보자. 그리고 각각의 확률변수는 모두 독립적이다. 이를 간단히 표현하면 다음과 같다. 이때, ibd는 identically and independently distributed의 약자이다. 확률변수가 독립적이며 동일한 분포를 취한다는 뜻이다. 이를 수식으로 쓰면 \eqref{eq:centass}와 같다.

\begin{equation}
X_{1},X_{2},....X_{n} \sim ibd N(\mu , \sigma^2)
\label{eq:centass}
\end{equation}
...
\begin{equation}
\bar{X}= \frac{X_{1}+X_{2}+X_{3}+X_{4}+X_{5}}{5}= \frac{\sum_{i=1}^{N}X_{1}}{N}
\label{eq:samplemean}
\end{equation}
...
\eqref{eq:samplemeaneq}와 \eqref{eq:samplemeanvar}를 다시 정리해보면 \eqref{eq:centrltheorem}과 같다. 표본평균의 분포는 모집단의 평균과 같은 \(μ\)를 평균으로 하고, 모집단의 분산 \(σ^2\) 를 사례수 N으로 나눈 \(σ^2/N\) 을 분산으로 하는 정규분포의 형태를 취하게 된다. \eqref{eq:centrltheorem}은 표본평균의 표본분포(sampling distrigution of sample mean)
...
만약 우리가 이 모집단 5명에게 모두 접근할 수 있어서 표본을 추출해야 한다고 가정해보자. 표본은 1명 추출(n=1), 2명 추출(n=2), 3명추출(n=3)까지 다양히 시도해보자.
...
이 사례에서 우리는 모집단의 분포를 알고 있다. 1부터 6까지 균등한 상대도수(p=1/6)를 갖고 있는 유니폼분포이며, 평균은 3, 분산은 2.916이다. 이 모집단에서 표본을 1개, 2개, 3개로 추출해보니, \textbf{표본평균}의 평균은 3으로 모집단의 평균과 같고, 분산은 모집단의 분산보다 작으며, 표본수(n)가 증가할 수록 분산은 점점 작아지는 것을 알 수 있다. 따라서 \eqref{eq:centrltheorem}가 확인됨을 알 수 있다.
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-86-1.png}}
...
먼저 추정에 대해 이해해보자. 추정(estimation)이란 표본의 통계량을 통해 모집단의 파라메터를 찾는 것이다. 먼저 모집단의 평균을 추정한다고 생각해보자. 우리가 갖고 있는 것은 모집단에서 추출될 수 있는 무수히 많은 경우의 수 중에 하나인 표본의 평균(\(\bar{X}\))이다. 모집단의 평균인 (\(\mu\))를 추정하기 위해서 사용할 수 있는 것은 표본의 평균(\(\bar{X}\))이다. 당연하게도 \(\bar{X}\)는 모집단 평균(\(\mu\))와 일치하지 않는다. 그렇지만 \(\mu\)를 추정하기 위해 사용할 수 있는 최선의 추정량이 \(\bar{X}\) 이다.
하지만 앞서 살펴본 중심극한정리를 상기해보면 모집단의 평균(\(\mu\))은 표본의 평균이 아니라 표본평균의 평균과 근사한다. 즉, 수많은 표본을 추출하고 각각의 표본에서 추출한 표본의 평균의 평균이 모집단의 평균과 같다는 것이다.
즉, 우리가 갖고 있는 특정한 표본의 평균은 표본평균의 평균에서 어느정도 떨어져있을 것이다. 이것이 바로 표준오차(standard error)이다. 표준오차에 대해서는 가설검정시 다시 설명하도록 하겠다.
...
\begin{equation}
\left [ \mu - t_{(\frac{\alpha}{2}, n-1)}\times \frac{S}{\sqrt{n}},\quad \quad \quad \mu + t_{(\frac{\alpha}{2}, n-1)}\times \frac{S}{\sqrt{n}} \right ]
...
\begin{equation}
\begin{array}{cl}
\left [ 170-1.96\times \frac{10}{5}, \quad  170+1.96\times \frac{10}{5} \right ] 
\\
=\left [ 166.08, \quad173.92 \right ]
\end{array}
\label{eq:interval}
\end{equation}
...
\item
  2개 모집단의 평균 차이 검정 :
  단일 모집단 t 검정 : (H1: 서울대학교 남학생의 입학당시 IQ와 졸업당시 IQ는 차이가 있다. )
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-91-1.png}} \pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-91-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-96-1.png}} \pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-96-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-97-1.png}} \pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-97-2.png}} \pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-97-3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-101-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-105-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-106-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-108-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{_main_files/figure-latex/unnamed-chunk-109-1.png}}
